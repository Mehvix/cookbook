...
def getCapacity() -> int:
    try:
        ...
        value = driver.find_element_by_css_selector(
            "#root > div > div > div.styles_main__3Ul1n.styles_sidebarOpen__1t7th >"
            " div.styles_waitTimeFullnessWrapper__3PRdQ > div > span"
        ).text
        # print(value)
...
sheet = client.open_by_key("1KqE5Pk76Wc9hizXjJeClh_oZwjqtYbetqRLfvxZerJ4").sheet1
...
cap = getCapacity()
if cap > 11:  # sometimes RSF doesn't zero properly
